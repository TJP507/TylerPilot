...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"OffroadScreenOffBrightness", {PERSISTENT | BACKUP, INT, "0"}},
    {"OffroadScreenOffBrightnessMigrated", {PERSISTENT | BACKUP, STRING, "0.0"}},
    {"OffroadScreenOffTimer", {PERSISTENT | BACKUP, INT, "0"}},
    {"OffroadScreenOffTimerMigrated", {PERSISTENT | BACKUP, STRING, "0.0"}},
